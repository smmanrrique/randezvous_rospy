...
// (in-package exe2_rendezvous.msg)
...
class queue_position_plot {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new queue_position_plot(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new queue_position_plot(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = queue_position_plot;
